...
template<>
std::string GetLatestProfile<ID3D11ComputeShader>(ComPtr<ID3D11Device> device);
...
template<>
void CreateShader<ID3D11VertexShader>(ComPtr<ID3D11Device> device, ComPtr<ID3DBlob> pShaderBlob, ID3D11ClassLinkage* pClassLinkage, ComPtr<ID3D11VertexShader>& ret);

template<>
void CreateShader<ID3D11PixelShader>(ComPtr<ID3D11Device> device, ComPtr<ID3DBlob> pShaderBlob, ID3D11ClassLinkage* pClassLinkage, ComPtr<ID3D11PixelShader>& ret);

template<>
void CreateShader<ID3D11ComputeShader>(ComPtr<ID3D11Device> device, ComPtr<ID3DBlob> pShaderBlob, ID3D11ClassLinkage* pClassLinkage, ComPtr<ID3D11ComputeShader>& ret);

/// <summary>
/// Get latest d3d profile of compute shader
/// </summary>
...
/// <param name="ret"></param>
template<>
void CreateShader<ID3D11ComputeShader>(
    ComPtr<ID3D11Device> device,
    ComPtr<ID3DBlob> pShaderBlob,
    ID3D11ClassLinkage* pClassLinkage,
    ...
    )
{
    ...
    device->CreateComputeShader(pShaderBlob->GetBufferPointer(), pShaderBlob->GetBufferSize(), pClassLinkage, &ret);
}
